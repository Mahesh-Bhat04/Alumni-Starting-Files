                    ...
                    {data.isApproved === 'pending' &&
                         (<div className='flex p-4 mb-4 text-yellow-800 bg-yellow-50 rounded-lg'>
                            ...
                            <div className='ml-3 text-sm font-medium'>
                                To get approval please complete your profile. After completion your profile will be approved within 3 days
                            </div>
                         </div>)}
                         <div className='mt-8'>
                            {tab==='overview' && <div>
                                <div className='flex items-center gap-4 mb-10'>
                                    ...
                                    <div>
                                        <span className='bg-[#CCF0F3] text-iriBlueColor py-1 px-4 lg:py-2 
                                        lg:px-6 text-[12px] leading-4 lg:text[16px] lg:leading-6 font-semibold'>
                                            Surgeon
                                        </span>
                                        ...
                                        <p class="text__para font-[15px] lg:max-w-[390px] leading-6;">
                                            doctor bio
                                        </p>
