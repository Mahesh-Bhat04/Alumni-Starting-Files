          ...
          <div className="container">
            <div className="flex items-center justify-between flex-col lg:flex-row">
              ...
              <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
                ...
                <div className="w-[150px] lg:w-[150px] xl:w-[240px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
          ...
          <div className="container">
            <div className="flex justify-between gap-[50px] lg:gap-0">
              ...
              <div className="w-full md:w-1/2">
                <h2 className="heading ">Most freuently asked questions by our beloved patients</h2>
